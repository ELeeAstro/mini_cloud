module mini_cloud_2_mix_mod
  ...
  subroutine mini_cloud_2_mix(T_in, P_in, grav_in, mu_in, bg_VMR_in, t_end, sp, sp_bg, q_v, q_0, q_1)
    implicit none
  ...
  subroutine calc_cond(n_eq, y, r_c, Kn, n_v, sat, dmdt)
    ...
    dmdt_high = 4.0_dp * pi * r_c**2 * vth * m0 * n_v * (1.0_dp - 1.0_dp/sat)
