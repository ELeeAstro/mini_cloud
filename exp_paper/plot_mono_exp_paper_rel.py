...
ax1.set_xticks(np.arange(0.0, 2.3, step=0.2))
ax2.set_xticks(np.arange(0.0, 2.3, step=0.2))
ax1.set_xticks(np.arange(0.0, 2.2, step=0.01),minor=True)
ax2.set_xticks(np.arange(0.0, 2.2, step=0.01),minor=True)
