module mini_dihrt_i_radau5
  ...
  public ::  mini_dihrt_radau5, RHS_update, jac_dummy, mas_dummy, solout

contains

  subroutine mini_dihrt_radau5(n_dust, T_in, P_in, t_end, sp, k, k3, VMR)
    implicit none
    ...
    iwork(4) = 0   ! Use zero stating values for Newton iterations? - default 0
    iwork(5) = neq ! Dimension of system
    iwork(6) = 0
    iwork(7) = 0
    ...
    do while((t_now < t_end))
      ...
      call RADAU5(neq,RHS_update,t_now,y,t_end,dt_init, &
        &                  rtol,atol,itol, &
  ...
  end subroutine mini_dihrt_radau5
...
end module mini_dihrt_i_radau5
