module mini_dihrt_i_rodas
  ...
  public ::  mini_dihrt_rodas, RHS_update, jac_dummy, mas_dummy, solout

contains

  subroutine mini_dihrt_rodas(n_dust, T_in, P_in, t_end, sp, k, k3, VMR)
    implicit none
    ...
    do while((t_now < t_end))
      ...
      call  RODAS(neq,RHS_update,ifcn,t_now,y,t_end,dt_init, &
      &                  rtol,atol,itol, &
  ...
  end subroutine mini_dihrt_rodas
